<div>
    ...
    <div class="mt-6">
        ...
        @if($tab == 'contents')
            @livewire('frontend.channel.table.videos-table', ['channel_id' => $channel->id ])
        @endif
        ...
        @if($tab == 'realtime')
            @livewire('frontend.channel.partial.channel-analytics', ['channel_id' => $channel->id ])
        @endif
    </div>
</div>
