...
<x-livewire-tables::table.cell class="md:table-cell flex justify-end items-center">
    <a wire:click="$emit('openModal', 'channel.modal.view-content', {{ json_encode(["video_id" => $row->id]) }})" class="cursor-pointer font-medium mr-2">View</a>
    <a wire:click="$emit('openModal', 'channel.modal.edit-content', {{ json_encode(["video_id" => $row->id]) }})" class="cursor-pointer text-blue-600 font-medium hover:text-blue-900 mr-2">Edit</a>
    <a wire:click="$emit('openModal', 'channel.modal.delete-content', {{ json_encode(["video_id" => $row->id]) }})" class="cursor-pointer text-red-600 font-medium hover:text-red-900">Delete</a>
</x-livewire-tables::table.cell>
